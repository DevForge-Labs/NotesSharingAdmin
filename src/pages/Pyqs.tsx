  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight font-heading">PYQs Repository Management</h2>
          <p className="text-sm text-muted-foreground">
            Manage, review, and inspect student-submitted previous year question papers.
          </p>
        </div>
        <Button variant="outline" size="sm" onClick={fetchPyqs} className="flex items-center gap-1.5 shrink-0 bg-card">
